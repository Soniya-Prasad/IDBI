...
Dim showAvatarsInTextChat
showAvatarsInTextChat=1

Dim usersCanInviteToRoom
usersCanInviteToRoom=1

Dim usersCanInviteToViewCam
usersCanInviteToViewCam=1

Dim sessionTimeStamp
sessionTimeStamp=DateDiff("s", "01/01/1970 00:00:00", Now())

Dim enableFBandTwitterInvite
enableFBandTwitterInvite=1

Dim onlyBroadcastersCanViewOtherCams
onlyBroadcastersCanViewOtherCams=0

Dim hideTheseRooms
hideTheseRooms=""

Dim enableMusicForRooms
enableMusicForRooms=1

Dim enableWebcamDocking
enableWebcamDocking=0

Dim enableEncryptedSettings
enableEncryptedSettings=1
...
Dim thumbnailImageShape
thumbnailImageShape="round"

Dim hideTextChat
hideTextChat=0

Dim moveUsersListToTheRight
moveUsersListToTheRight  = 0
...
Response.write("&previewEnabled=" & previewEnabled)
Response.write("&showJLMessages=" & showJLMessages)
...
Response.write("&showImageThumbs=" & showImageThumbs)
...
Response.write("&ignorePMEnabled=" & ignorePMEnabled)
...
Response.write("&blockBuzzEnabled=" & blockBuzzEnabled)
...
Response.write("&PPVEnabled=" & PPVEnabled)
Response.write("&PPVLink=" & PPVLink)
Response.write("&PPVAmount=" & PPVAmount)
Response.write("&PPVType=" & PPVType)
Response.write("&PPVTrigger=" & PPVTyPPVTriggerpe)
Response.write("&PPVIcon=" & PPVIcon)
Response.write("&PPVRatio=" & PPVRatio)
Response.write("&embedLinkURL=" & embedLinkURL)
Response.write("&embedTabEnabled=" & embedTabEnabled)
Response.write("&showOnlyRooms=" & showOnlyRooms)
Response.write("&showAvatarsInTextChat=" & showAvatarsInTextChat)
Response.write("&usersCanInviteToRoom=" & usersCanInviteToRoom)
Response.write("&usersCanInviteToViewCam=" & usersCanInviteToViewCam)
Response.write("&sessionTimeStamp=" & sessionTimeStamp)
Response.write("&enableFBandTwitterInvite=" & enableFBandTwitterInvite)
Response.write("&onlyBroadcastersCanViewOtherCams=" & onlyBroadcastersCanViewOtherCams)
Response.write("&hideTheseRooms=" & hideTheseRooms)
Response.write("&enableMusicForRooms=" & enableMusicForRooms)
Response.write("&enableWebcamDocking=" & enableWebcamDocking)
Response.write("&enableEncryptedSettings=" & enableEncryptedSettings)
Response.write("&outGoingBuffer=" & outGoingBuffer)
Response.write("&googleAPIkey=" & googleAPIkey)
Response.write("&thumbnailImageShape=" & thumbnailImageShape)
Response.write("&hideTextChat=" & hideTextChat)
Response.write("&moveUsersListToTheRight=" & moveUsersListToTheRight)
Response.write("&licenseKey=" & licenseKey)
%>