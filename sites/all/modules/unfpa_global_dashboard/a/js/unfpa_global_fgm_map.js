...
(function ($) {
//  Drupal.behaviors.unfpa_global_data = {
//    attach: function (context, settings) {
//      simplemaps_worldmap_mapdata.state_specific = Drupal.settings.unfpa_global_data['trends'];
//
////      selOpt = 'projections';
//      //  simplemaps_worldmap_mapdata.state_specific = Drupal.settings.mapdata['age_at_fgm'];
//      console.log(Drupal.settings.mapdata['age_at_fgm']);
//    }
//  };
...
//  };
  ...
  $(document).ready(function () {
    default_indicator = 'prevelance';
    worldmap_mapdata(default_indicator);

    $(".open-data-dashboard-tabs label").click(function (event) {
...
//      $(".loader").show().delay(500).fadeOut();
    ...
    $(".open-data-dashboard-tabs ul li").click(function () {
//      $(".loader").show().delay(500).fadeOut();
      $(this).find('li.first .iCheck-helper').attr("checked", true).trigger("click");
    });

    $(".open-data-dashboard-tabs .iCheck-helper").click(function () {
      $(".loader").show().delay(500).fadeOut();
  ...
  function worldmap_mapdata(selOpt) {
    simplemaps_worldmap_mapdata.state_specific = Drupal.settings.unfpa_global_data[selOpt];

    var country_code = Drupal.settings.unfpa_global_data[selOpt];
