 ...
 * @version 0.5
 */
di_jq.widget("daredevel.checkboxTree", {
 ...
 */
    ...
    _create: function() {
        ...
        if (this.options.collapsable) {
            ...
            //this.element.find("li:not(:has(ul))").each(function() {
             //   di_jq(this).prepend(di_jq('<span />'));
              //t._markAsLeaf(di_jq(this));
			//});

            // initialize checked nodes
            this.element.find("li:has(ul):has(input:checkbox:checked)").each(function() {
                di_jq(this).prepend(di_jq('<span />'));
                t.options.initializeChecked == 'collapsed' ? t.collapse(di_jq(this)) : t.expand(di_jq(this));
            });

            // initialize unchecked nodes
            this.element.find("li:has(ul):not(:has(input:checkbox:checked))").each(function() {
                di_jq(this).prepend(di_jq('<span />'));
                t.options.initializeUnchecked == 'collapsed' ? t.collapse(di_jq(this)) : t.expand(di_jq(this));
            });

            // bind collapse/expand event
            this.element.find('li span').live("click", function() { 
                //di_jq(this).closest('li').attr('id');
				//callchild(di_jq(this).parent('li').attr('id')); // li id and pass to the function

				li = di_jq(this).parents("li:first");
            ...
            this.element.find('li label').live("click", function() {
                //di_jq(this).closest('li').attr('id');
				//callchild(di_jq(this).parent('li').attr('id')); // li id and pass to the function
            ...
            di_jq(this.options.collapseAllElement).bind("click", function() {
                t.collapseAll();
            });

            // bind expand all element event
            di_jq(this.options.expandAllElement).bind("click", function() {
                t.expandAll();
            });
            ...
            if (this.options.onUncheck.node == 'collapse') {
                this.element.find('input:checkbox:not(:checked)').live("click", function() {
                    t.collapse(di_jq(this).parents("li:first"));
                });
            } else
            ...
            if (this.options.onUncheck.node == 'expand') {
                this.element.find('input:checkbox:not(:checked)').live("click", function() {
                    t.expand(di_jq(this).parents("li:first"));
                });
            }
        ...
        this.element.find('input:checkbox:not(:checked)').live('click', function() {
            var li = di_jq(this).parents('li:first');
			//alert(t.toSource());
			if(t.options.trueCheck.val=='yes')
            t.uncheck(li); // commented on 13 Sept by DG26
        });
        ...
        this.element.find('input:checkbox:checked').live('click', function() {
			...
			//alert(t.toSource());
			if(t.options.trueCheck.val=='yes')
            t.check(li); // commented on 13 Sept by DG26
        });
    ...
    _checkOthers: function(li) {
        ...
        di_jq(this.element).find('li').each(function() {
            if (!di_jq(this).hasClass('exclude')) {
                di_jq(this).find('input:checkbox:first:not(:checked)').attr('checked', 'checked').change();
            }
        });
        di_jq(this.element).find('li').removeClass('exclude');
    },
    ...
    _destroy: function() {
        ...
        di_jq.Widget.prototype.destroy.call(this);
    },
    ...
    _uncheckOthers: function(li) {
        ...
        di_jq(this.element).find('li').each(function() {
            if (!di_jq(this).hasClass('exclude')) {
                di_jq(this).find('input:checkbox:first:checked').attr('checked', '').change();
            }
        });
        di_jq(this.element).find('li').removeClass('exclude');
    },
     ...
     */
    checkAll: function() {
        di_jq(this.element).find('input:checkbox:not(:checked)').attr('checked', 'checked').change();
    },
    ...
    collapseAll: function() {
        var t = this;
        di_jq(this.element).find('li.expanded').each(function() {
            t.collapse(di_jq(this));
        });
    },
    ...
    expandAll: function() {
        var t = this;
        di_jq(this.element).find('li.collapsed').each(function() {
            t.expand(di_jq(this));
        });
    },
     ...
     */
    uncheckAll: function() {
        di_jq(this.element).find('input:checkbox:checked').attr('checked', '').change();
    },
