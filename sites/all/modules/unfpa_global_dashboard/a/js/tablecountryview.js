...
//      chartTable = '<div id="' + this.visTblDvId + '" class="dfapi-visTbl-container" style="height:auto; width: ' + printwidth + 'px;">';
      chartTable = '<div id="' + this.visTblDvId + '" class="dfapi-visTbl-container" style="height:auto; width: 453px;">';
    } else {
  ...
  this.initHighChartTableData = function () {
    ...
    Highcharts.Chart.prototype.getData = function () {
      ...
      csv = '<table cellpadding="0" cellspacing="0" width="430px" style="margin-top: 0px;" id="' + dfa_tableview.visTblId + '">' + trHd + ' <tbody>' + trData + '</tbody></table>';
