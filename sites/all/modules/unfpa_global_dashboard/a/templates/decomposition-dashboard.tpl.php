...
<?php
  ...
  foreach ($areaList as $key=>$value){
   $areaList['Area']['Area_NId'] = $value->Area_NId;
   $areaList['Area']['Area_Parent_NId'] = $value->Area_Parent_NId;
   $areaList['Area']['Area_ID'] = $value->Area_ID;
   $areaList['Area']['Area_Name'] = $value->Area_Name;
   $areaList['Area']['Area_GId'] = $value->Area_GId;
   $areaList['Area']['Area_Level'] = $value->Area_Level;
  }
echo "<script>";
echo 'var Area_NId = ' . $areaList['Area']['Area_NId'] . ';';
echo 'var Area_Parent_NId = ' . $areaList['Area']['Area_Parent_NId'] . ';';
