...
<!--<script src="http://highcharts.github.io/export-csv/export-csv.js" type="text/javascript"></script>-->
<h1 id="page-title" class="title custom-page-title">Adolescents and Youth Dashboard - <?php echo $country_name; ?></h1>
  ...
  <div class="thepopover">
    ...
    <div id="family-planning-countries">
      <div class="area">
        ...
        <ul>
          <?php foreach ($areaList['areaIDNameArr'] as $ay_country_code => $ay_country_name): ?>
            <li><a href="/data/adolescent-youth/<?php print $ay_country_code; ?>"> <?php print $ay_country_name; ?></a></li>
          <?php endforeach; ?>
        </ul>
      </div>
    </div>
...
<div id="population-distribution-section" class="dashboard-country-outer-box adolescents-youth-dashboard">
  <div class="dashboard-section-title">
    <span class="section-title">Population Distribution, by Residence and Region - <?php echo $country_name; ?></span>
  </div>
...
<div id="child-marriage-section" class="dashboard-country-outer-box adolescents-youth-dashboard">
  <div class="dashboard-section-title">
    <span class="section-title">Child Marriage - <?php echo $country_name; ?></span>
  </div>
  ...
  <div class="dashboard-section-content dashboard-country-chart-section clearfix">
    <h2 class="dashboard-country-chart-section-title">Percentage of women aged 20-24 who got married before age 15</h2>
    <div class="country-chart-section-left chart-sections">
      ...
      <div id="filter-options-list">
        <ul class="square-input-element filter_cm_age_by_18_15">
          <li class="filter-option"><span><input class="first" type="radio" name="ay-indicator-filter" id="cm_age_by_15" value="perc_girl_age_20_24_mrd_bfr_15" checked="true" ><label>before age 15</label><span style="display: none;">Percentage of women aged 20-24 who got married before age 15</span></li>
          <li class="filter-option"><span><input type="radio" name="ay-indicator-filter" id="cm_age_by_18" value="perc_girl_age_20_24_mrd_bfr_18"><label>before age 18</label><span style="display: none;">Percentage of women aged 20-24 who got married before age 18</span></span></li>
        </ul>
      </div>
      ...
      <div id="action-links" class="action-links-block">
        <ul class="action-link-list dfapi-viz-toolbar">
          <li class="table-icon" rel="print"><a class="table map_table" id="table_cm_age_by_18_15" href="javascript:void(0);">Table</a></li>
          ...
          <li rel="download" class="download">
            ...
            <div rel="download" class="download-link-options dwnld-opts">
              ...
              <a id="csv" type="csv" href="javascript:void(0);" class="export_icons">CSV </a>
            </div>
          </li>
        </ul>
      </div>
    ...
    <div class="country-chart-section-right chart-sections">
      ...
      <div id="map_render_child_mrg" class="chart-map-block map-div">
        <!--<div class="logo-unfpa">hello</div>-->
        <h2 class="dashboard-country-chart-section-title print-subtitle" style="display: none;">Percentage of women aged 20-24 who got married before age 15</h2>
      ...
      <div class="chart-map-block columnleft">
        <div class="CO3">
          ...
          <div id="p-VO_8">
            <h2 class="dashboard-country-chart-section-title print-subtitle" style="display: none;">Percentage of women aged 20-24 who got married before age 18 or 15</h2>
            <!-- graph div -->
...
<div id="adolescent-pregnancy-section" class="dashboard-country-outer-box adolescents-youth-dashboard">
  <div class="dashboard-section-title">
    <span class="section-title">Adolescent pregnancy - <?php echo $country_name; ?></span>
  </div>
  <div class="dashboard-section-content dashboard-country-chart-section clearfix">
    <h2 class="dashboard-country-chart-section-title">Percentage of women aged 20-24 who gave birth before age 15</h2>
    <div class="country-chart-section-left chart-sections">

      <div id="chart-buttons-wrapper" class="clearfix">
        <button type="button" class="button map" id="filter_ay_adolescent_age_by_18_15">Map</button>
        <button type="button" class="button graph active" id="graph_ay_adolescent_age_by_15">Graph</button>
        <!--        <button type="button" class="button table graph_table" id="table_ay_adolescent_age_by_18_15">Table</button>-->
      </div>

      <div id="filter-options-list">
        <ul class="square-input-element filter_ay_adolescent_age_by_18_15" style="display:none;">
          <li class="filter-option"><span><input class="first" type="radio" name="ay-adolescent-indicator-filter" id="ay_adolescent_age_by_15" value="perc_girl_age_20_24_gave_birth_bfr_15" checked="true" ><label>before age 15</label><span style="display: none;">Percentage of women aged 20-24 who gave birth before age 15</span></span></li>
          <li class="filter-option"><span><input type="radio" name="ay-adolescent-indicator-filter" id="ay_adolescent_age_by_18" value="perc_girl_age_20_24_gave_birth_bfr_18"><label>before age 18</label><span style="display: none;">Percentage of women aged 20-24 who gave birth before age 18</span></span></li>
        </ul>
      </div>
      ...
      <div id="action-links" class="action-links-block">
        <ul class="action-link-list dfapi-viz-toolbar">
          <li class="table-icon" rel="print"><a class="table map_table graph_table" id="table_ay_adolescent_age_by_18_15" href="javascript:void(0);">Table</a></li>
          <li class="full-view" rel="print"><a class="full-view-link fullscreen" href="javascript:void(0);">Full View</a></li>
          <li class="print" rel="print"><a class="print-link dfapi-viz-toolbar-medium print" href="javascript:void(0);">Print</a></li>
          <li rel="download" class="download">
            <a href="javascript:void(0);" class="download-link">Download</a>
    ...
    <div class="country-chart-section-right chart-sections">
      <div id="map_render" class="map-div">
        <h2 class="dashboard-country-chart-section-title print-subtitle" style="display: none;">Percentage of women aged 20-24 who gave birth before age 18 or 15</h2>
        <!-- graph div -->
        <div class="map_part" id='map_area_indicator_data_adolescent_prg' style="height:450px;margin-top:-15px;display: none;"></div>
      </div>
      ...
      <div id="p-VO_9">
        <h2 class="dashboard-country-chart-section-title print-subtitle" style="display:none">Percentage of women aged 20-24 who gave birth before age 18 or 15</h2>
        <!-- graph div -->
        <div class="graph flt_lft wid99 bar_chart graph_ay_adolescent_age_by_15 table_ay_adolescent_age_by_18_15" id="graph_adolescnt_prg"></div>
      </div>
...
<div id="sexual-reproductive-health-section" class="dashboard-country-outer-box adolescents-youth-dashboard">
  <div class="dashboard-section-title">
    <span class="section-title">Sexual & Reproductive Health - <?php echo $country_name; ?></span>
  </div>
  ...
  <div class="dashboard-section-content dashboard-country-chart-section clearfix">
    <h2 class="dashboard-country-chart-section-title">Percentage of females aged 15-19 who have comprehensive Knowledge of HIV/AIDS</h2>
    <div class="country-chart-section-left chart-sections">
      ...
      <div id="filter-options-list">
        <ul class="square-input-element filter_sr_have_knwldg_hiv_aids_age_by_18_15">
          <li class="filter-option"><span><input class="first" type="radio" name="ay-sr-indicator-filter" id="sr_age_by_15_24" value="perc_girl_age_15_19_have_knwldg_hiv_aids" checked="true" ><label> age 15-19</label><span style="display: none;">Percentage of females aged 15-19 who have comprehensive Knowledge of HIV/AIDS</span></span></li>
          <li class="filter-option"><span><input type="radio" name="ay-sr-indicator-filter" id="sr_age_by_15_24" value="perc_girl_age_20_24_have_knwldg_hiv_aids"><label> age 20-24</label><span style="display: none;">Percentage of females aged 20-24 who have comprehensive Knowledge of HIV/AIDS</span></span></li>
        </ul>
      </div>
      <div id="filter-options-list">
      ...
      <div id="action-links" class="action-links-block">
        <ul class="action-link-list dfapi-viz-toolbar">
          <li class="table-icon" rel="print"><a class="table map_table" id="table_sr_have_knwldg_hiv_aids_age_by_18_15" href="javascript:void(0);">Table</a></li>
          <li class="full-view" rel="print"><a class="full-view-link fullscreen" href="javascript:void(0);">Full View</a></li>
          <li class="print" rel="print"><a class="print-link dfapi-viz-toolbar-medium print" href="javascript:void(0);">Print</a></li>
          <li rel="download" class="download">
            <a href="javascript:void(0);" class="download-link">Download</a>
    ...
    <div class="country-chart-section-right chart-sections">
      <div id="map_render_sexual_reprd" class="chart-map-block map-div">
        <h2 class="dashboard-country-chart-section-title print-subtitle" style="display: none;">Percentage of females aged 15-24 who have comprehensive Knowledge of HIV/AIDS</h2>
        <!-- graph div -->
...
<div id="family-planning-section" class="dashboard-country-outer-box adolescents-youth-dashboard">
  <div class="dashboard-section-title">
    <span class="section-title">Family Planning - <?php echo $country_name; ?></span>
  </div>
  ...
  <div class="dashboard-section-content dashboard-country-chart-section clearfix">
    <h2 class="dashboard-country-chart-section-title">Percentage of currently married/in union females aged 15-19 who are currently using any contraceptive method</h2>
    <div class="country-chart-section-left chart-sections">


      <div id="chart-buttons-wrapper" class="clearfix">
        <button type="button" class="button map" id="filter_fm_age_15_19_using_contrcptn_mthd" >Map</button>
        <button type="button" class="button graph active" name="graphfilter_fm_age_15_19_using_contrcptn_mthd" id="graph_fm_age_15_19_using_contrcptn_mthd">Graph</button>
        <!--        <button type="button" class="button table graph_table" id="table_fm_age_15_19_using_contrcptn_mthd">Table</button>-->
      </div>


      <div id="filter-options-list">
        <ul class="square-input-element filter_fm_age_15_19_using_contrcptn_mthd" style="display:none;">
          <li class="filter-option"><span><input class="first" type="radio" name="ay-fm-using-ctrcpn-indicator-filter" id="fm_using_ctrcpn_age_by_15_24" value="perc_mrd_girl_age_15_19_using_contrcptn_mthd" checked="true" ><label> age 15-19</label><span style="display: none;">Percentage of currently married/in union females aged 15-19 who are currently using any contraceptive method</span></span></li>
          <li class="filter-option"><span><input type="radio" name="ay-fm-using-ctrcpn-indicator-filter" id="fm_using_ctrcpn_age_by_15_24" value="perc_mrd_girl_age_20_24_using_contrcptn_mthd"><label> age 20-24</label><span style="display: none;">Percentage of currently married/in union females aged 20-24 who are currently using any contraceptive method</span></span></li>
        </ul>
      </div>
      <div id="filter-options-list">
        <ul class="square-input-element graphfilter graphfilter_fm_age_15_19_using_contrcptn_mthd graphfilter_fm_age_15_19_using_mdrn_contrcptn_mthd graphfilter_fm_age_15_19_not_using_contrcptn_mthd">
      ...
      <div id="filter-options-list">
        <ul class="square-input-element filter_fm_age_15_19_not_using_contrcptn_mthd" style="display:none;">
          <li class="filter-option"><span><input class="first" type="radio" name="ay-fm-not-using-ctrcpn-indicator-filter" id="fm_not_using_ctrcpn_age_by_15_19" value="perc_mrd_girl_age_15_19_not_using_contrcptn_mthd" checked="true" ><label> age 15-19</label><span style="display: none;">Percentage of currently married/in union females aged 15-19 who are not currently using any contraceptive method</span></span></li>
          <li class="filter-option"><span><input type="radio" name="ay-fm-not-using-ctrcpn-indicator-filter" id="fm_not_using_ctrcpn_age_by_20_24" value="perc_mrd_girl_age_20_24_not_using_contrcptn_mthd"><label> age 20-24</label><span style="display: none;">Percentage of currently married/in union females aged 20-24 who are not currently using any contraceptive method</span></span></li>
        </ul>
      </div>
      <div id="filter-options-list">
        <ul class="square-input-element filter_fm_age_15_19_unmet_need" style="display:none;">
          <li class="filter-option"><span><input class="first" type="radio" name="ay-fm-unmet-need-indicator-filter" id="fm_unmet_need_age_by_15_24" value="perc_mrd_girl_age_15_19_hv_unmet_need_fml_pln" checked="true" ><label> age 15-19</label><span style="display: none;">Percentage of currently married/in union females aged 15-19 who have an unmet need for family planning</span></span></li>
          <li class="filter-option"><span><input type="radio" name="ay-fm-unmet-need-indicator-filter" id="fm_unmet_need_age_by_15_24" value="perc_mrd_girl_age_20_24_hv_unmet_need_fml_pln"><label> age 20-24</label><span style="display: none;">Percentage of currently married/in union females aged 20-24 who have an unmet need for family planning</span></span></li>
        </ul>
      </div>
      ...
      <div id="action-links" class="action-links-block">
        <ul class="action-link-list dfapi-viz-toolbar">
          <li class="table-icon" rel="print"><a class="table map_table graph_table" id="table_fm_age_15_19_using_contrcptn_mthd" href="javascript:void(0);">Table</a></li>
          <li class="full-view" rel="print"><a class="full-view-link fullscreen" href="javascript:void(0);">Full View</a></li>
          <li class="print" rel="print"><a class="print-link dfapi-viz-toolbar-medium print" href="javascript:void(0);">Print</a></li>
          <li rel="download" class="download">
            <a href="javascript:void(0);" class="download-link">Download</a>
    ...
    <div class="country-chart-section-right chart-sections">
      <div id="map_render_family_planning" class="chart-map-block map-div">
        <h2 class="dashboard-country-chart-section-title print-subtitle" style="display: none;">Percentage of currently married/in union females aged 15-24 who are currently using any contraceptive method</h2>
        <!-- graph div -->
        <div class="map_part" id='map_area_indicator_data_family_planning' style="height:450px;margin-top:-15px;display: none;"></div>
      </div>
...
<div id="gender-equality-section" class="dashboard-country-outer-box adolescents-youth-dashboard">
  <div class="dashboard-section-title">
    <span class="section-title">Gender Equality - <?php echo $country_name; ?></span>
  </div>
  ...
  <div class="dashboard-section-content dashboard-country-chart-section clearfix">
    <h2 class="dashboard-country-chart-section-title">Proportion of women 15-19 involved in decision making for contraceptive use</h2>
    <div class="country-chart-section-left chart-sections">
      ...
      <div id="filter-options-list">
        <ul class="square-input-element filter_ge_age_15_24_take_contrcptn_desc">
          <li class="filter-option"><span><input class="first" type="radio" name="ay-ge-contrcptn-desc-indicator-filter" id="ge_age_by_15_19_contrcptn_desc" value="perc_girl_age_15_19_take_contrcptn_desc_byself_or_with_hsbnd" checked="true" ><label> age 15-19</label><span style="display: none;">Proportion of women 15-19 involved in decision making for contraceptive use</span></span></li>
          <li class="filter-option"><span><input type="radio" name="ay-ge-contrcptn-desc-indicator-filter" id="sr_age_by_15_24_contrcptn_desc" value="perc_girl_age_20_24_take_contrcptn_desc_byself_or_with_hsbnd"><label> age 20-24</label><span style="display: none;">Proportion of women 20-24 involved in decision making for contraceptive use</span></span></li>
        </ul>
      </div>
      <div id="filter-options-list">
        <ul class="square-input-element filter_ge_age_15_24_take_own_hlth_desc" style="display:none;">
          <li class="filter-option"><span><input class="first" type="radio" name="ay-ge-own-hlth-descindicator-filter" id="sr_age_by_15_19_own_hlth_desc" value="perc_girl_age_15_19_take_own_hlth_desc_byself_or_with_hsbnd" checked="true" ><label> age 15-19</label><span style="display: none;">Proportion of women 15-19 involved in decision making for own health care</span></span></li>
          <li class="filter-option"><span><input type="radio" name="ay-ge-own-hlth-descindicator-filter" id="sr_age_by_15_24_own_hlth_desc" value="perc_girl_age_20_24_take_own_hlth_desc_byself_or_with_hsbnd"><label> age 20-24</label><span style="display: none;">Proportion of women 20-24 involved in decision making for own health care</span></span></li>
        </ul>
      </div>
      <div id="filter-options-list">
        <ul class="square-input-element filter_ge_age_15_24_contrcptn_dmnd_stsfd" style="display:none;">
          <li class="filter-option"><span><input class="first" type="radio" name="ay-ge-dmnd-stsfd-indicator-filter" id="sr_age_by_15_19_contrcptn_dmnd_stsfd" value="perc_mrd_girl_age_15_19_contrcptn_dmnd_stsfd" checked="true" ><label> age 15-19</label><span style="display: none;">Percentage of currently married/in union females aged 15-19 who have their contraception demand satisfied</span></span></li>
          <li class="filter-option"><span><input type="radio" name="ay-ge-dmnd-stsfd-indicator-filter" id="sr_age_by_15_24_contrcptn_dmnd_stsfd" value="perc_mrd_girl_age_20_24_contrcptn_dmnd_stsfd"><label> age 20-24</label><span style="display: none;">Percentage of currently married/in union females aged 20-24 who have their contraception demand satisfied</span></span></li>
        </ul>
      </div>
      ...
      <div id="action-links" class="action-links-block">
        <ul class="action-link-list dfapi-viz-toolbar">
          <li class="table-icon" rel="print"><a class="table map_table" id="table_ge_age_15_24_take_contrcptn_desc" href="javascript:void(0);">Table</a></li>
          <li class="full-view" rel="print"><a class="full-view-link fullscreen" href="javascript:void(0);">Full View</a></li>
          <li class="print" rel="print"><a class="print-link dfapi-viz-toolbar-medium print" href="javascript:void(0);">Print</a></li>
          <li rel="download" class="download">
            <a href="javascript:void(0);" class="download-link">Download</a>
    ...
    <div class="country-chart-section-right chart-sections">
      <div id="map_render_gender_equality" class="chart-map-block map-div">
        <h2 class="dashboard-country-chart-section-title print-subtitle" style="display: none;">Proportion of women 15-24 involved in decision making for contraceptive use</h2>
        <!-- graph div -->
...
<div id="young-people-section" class="dashboard-country-outer-box adolescents-youth-dashboard">
  <div class="dashboard-section-title">
    <span class="section-title">Young People - <?php echo $country_name; ?></span>
  </div>
  <div class="section-indicators" id="young-people-indicators">
    <ul id="tab1">

      <li class="first"><span><input type="radio" name="young-people-indicators" id="" class="ge_age_15_24_take_contrcptn_desc" value="perc_girl_age_15_19_take_contrcptn_desc_byself_or_with_hsbnd" checked="true"/><label class="label1">Proportion of women 15-24 involved in decision making for contraceptive use</label></span></li>

      <li class="second"><span><input type="radio" name="young-people-indicators" id="" class="ge_age_15_24_take_own_hlth_desc" value="perc_girl_age_15_19_take_own_hlth_desc_byself_or_with_hsbnd"/><label>Proportion of women 15-24 involved in decision making for own health care</label></span></li>

      <li class="third"><span><input type="radio" name="young-people-indicators" id="" class="ge_age_15_24_contrcptn_dmnd_stsfd" value="perc_mrd_girl_age_15_19_contrcptn_dmnd_stsfd"/><label>Percentage of currently married/in union females aged 15-24 who have their contraception demand satisfied</label></span></li>
  ...
  <div class="dashboard-section-content dashboard-country-chart-section clearfix">
    ...
    <div class="country-chart-section-left chart-sections">
      ...
      <div id="chart-buttons-wrapper" class="clearfix">
        <button type="button" class="button map active" id="filter_ge_age_15_24_take_contrcptn_desc1" >Map</button>
        <button type="button" class="button graph" name="graphfiltr" id="graph_ge_age_15_24_take_contrcptn_desc1">Graph</button>
        <!--        <button type="button" class="button table graph_table" id="table_ge_age_15_24_take_contrcptn_desc">Table</button>-->
      </div>
      ...
      <div id="filter-options-list">
        <ul class="square-input-element filter_ge_age_15_24_take_contrcptn_desc">
          <li class="filter-option"><span><input class="first" type="radio" name="ay-ge-contrcptn-desc-indicator-filter1" id="ge_age_by_15_19_contrcptn_desc" value="perc_girl_age_15_19_take_contrcptn_desc_byself_or_with_hsbnd" checked="true" ><label> age 15-19</label><span style="display: none;">Proportion of women 15-19 involved in decision making for contraceptive use</span></span></li>
          <li class="filter-option"><span><input type="radio" name="ay-ge-contrcptn-desc-indicator-filter1" id="sr_age_by_15_24_contrcptn_desc" value="perc_girl_age_20_24_take_contrcptn_desc_byself_or_with_hsbnd"><label> age 20-24</label><span style="display: none;">Proportion of women 20-24 involved in decision making for contraceptive use</span></span></li>
        </ul>
      </div>
      <div id="filter-options-list">
        <ul class="square-input-element filter_ge_age_15_24_take_own_hlth_desc" style="display:none;">
          <li class="filter-option"><span><input class="first" type="radio" name="ay-ge-own-hlth-descindicator-filter1" id="sr_age_by_15_19_own_hlth_desc" value="perc_girl_age_15_19_take_own_hlth_desc_byself_or_with_hsbnd" checked="true" ><label> age 15-19</label><span style="display: none;">Proportion of women 15-19 involved in decision making for own health care</span></span></li>
          <li class="filter-option"><span><input type="radio" name="ay-ge-own-hlth-descindicator-filter1" id="sr_age_by_15_24_own_hlth_desc" value="perc_girl_age_20_24_take_own_hlth_desc_byself_or_with_hsbnd"><label> age 20-24</label><span style="display: none;">Proportion of women 20-24 involved in decision making for own health care</span></span></li>
        </ul>
      </div>
      <div id="filter-options-list">
        <ul class="square-input-element filter_ge_age_15_24_contrcptn_dmnd_stsfd" style="display:none;">
          <li class="filter-option"><span><input class="first" type="radio" name="ay-ge-dmnd-stsfd-indicator-filter1" id="sr_age_by_15_19_contrcptn_dmnd_stsfd" value="perc_mrd_girl_age_15_19_contrcptn_dmnd_stsfd" checked="true" ><label> age 15-19</label><span style="display: none;">Percentage of currently married/in union females aged 15-19 who have their contraception demand satisfied</span></span></li>
          <li class="filter-option"><span><input type="radio" name="ay-ge-dmnd-stsfd-indicator-filter1" id="sr_age_by_15_24_contrcptn_dmnd_stsfd" value="perc_mrd_girl_age_20_24_contrcptn_dmnd_stsfd"><label> age 20-24</label><span style="display: none;">Percentage of currently married/in union females aged 20-24 who have their contraception demand satisfied</span></span></li>
        </ul>
      </div>
    ...
    <div class="country-chart-section-right chart-sections">
      <div id="map_render_young-people" class="chart-map-block map-div">
        <h2 class="dashboard-country-chart-section-title print-subtitle" style="display: none;">Proportion of women 15-24 involved in decision making for contraceptive use</h2>
        <!-- graph div -->
        <div class="map_part" id='map_area_indicator_data_young-people' style="height:450px;margin-top:-15px"></div>
      </div>
      <div id="p-VO_16">
        <h2 class="dashboard-country-chart-section-title print-subtitle" style="display: none;">Proportion of women 15-24 involved in decision making for contraceptive use</h2>
        <!-- graph div -->
...
<div id="dashboard-country-detail-bottom-section" class="dashboard-country-outer-box adolescents-youth-dashboard">
  ...
  <div class="dashboard-country-detail-section-content clearfix">
    <ul class="clearfix">
      ...
      <li class="list-row fgm-dashboard-list-row">
        <a href="<?php echo '/data/fgm/' . $country_code; ?>">
          <span class="country-dashboard-icons fgm-dashboard-icon"></span>
          <span class="country-dashboard-portal-title">FGM Dashboard</span>
        </a>
      </li>
