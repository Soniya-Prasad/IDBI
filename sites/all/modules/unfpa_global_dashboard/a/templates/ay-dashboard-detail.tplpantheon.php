<?php print $opendata_menu_section; ?>
<script src="../js/export-csv.js"></script>
<h1 id="page-title" class="title custom-page-title"><?php print t('Adolescents and Youth Dashboard'); ?> - <?php echo $country_name; ?></h1>
...
<div id="dashboard-country-detail-bottom-section" class="dashboard-country-outer-box adolescents-youth-dashboard">
  ...
  <div class="dashboard-country-detail-section-content clearfix">
    <ul class="clearfix">
      ...
      <?php if ($show_dashboard_fgm): ?>
        <li class="list-row fgm-dashboard-list-row">
          <a href="<?php print $fgm_country_dashboard_url; ?>">
