...
alert('in barchart');
    ...
    $.ajax({
      url: Drupal.settings.basePath + 'home/getBarChartData',
      type: 'POST',
      dataType: 'json',
      data: {'area_NID':area_nid,'indicator_nid':indicator_nid,'unit_nid':unit_nid,'sub_nid':sub_nid,'timeperiod':timeperiod},
...
// function to get chart data using area nid and ius
  function getTable1Data(area_nid, chartObj) {
    ...
    //debugger;
    var postData = 'area_NID=' + area_nid + '&indicator_nid=' + indicator_nid + '&unit_nid=' + unit_nid + '&sub_nid=' + sub_nid + '&timeperiod=' + timeperiod;
    callbackurl = Drupal.settings.basePath + 'home/getTable1Data';
    $.ajax({
      url: callbackurl,
      type: 'POST',
      dataType: 'json',
      ...
      success: function (data) {
        //debugger;
        //console.log('table data getting');
        //console.log(data);
        table1Data = data;
