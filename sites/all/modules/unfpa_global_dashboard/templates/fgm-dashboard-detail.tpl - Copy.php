...
<div id="fgm-overview-section" class="dashboard-country-outer-box fgm-dashboard">
  ...
  <div class="dashboard-section-content dashboard-country-chart-section levels chart clearfix">
        ...
        <div class="country-chart-middle-section middle-column chart-sections">
          ...
          <div class="conteudo">
            <div class="clearfix">
              ...
              <div id ="map_render" class="columnleft" style="width:400px; min-height:300px;margin-left: -65px;">
                <div   class="dfapi-viz-toolbar-icons">
                  <ul rel="MO1" class="dfapi-viz-toolbar" id="dfa_toolbar_MO1">
                    <li rel="fullScreen"><a href="javascript:void(0)" class="icon_two" title="FullScreen">FullScreen</a></li>
                    ...
                    <li rel="MO1" class="dwnld-option-li"><a href="javascript:void(0);"><i class="dfapi-viz-toolbar-medium dwnld">download</i></a>	<div rel="download" class="dwnld-opts">
                ...
                <div class="columnleft" class="map_div" id="mapDivId" style="height: 324px;">
    ...
    <div class="overview-chart-section overview-section conteudo" style="display: none;">
      <div class="repitem">
        ...
        <div id="graphCO7" class="parent_div"  style="position:relative;">
          ...
          <div class="icon_bg _mrgn_top20 top_rnded_crnrs3 hoverMenu" style="top:-19px;right:0px;">
            <a href="javascript:void(0)" class="icon_one" title="Table"></a>
            <a href="javascript:void(0)" class="icon_two" title="FullScreen">FullScreen</a>
            <a href="javascript:void(0)" class="icon_three" title="Print"></a>
            <a href="javascript:void(0)" class="icon_four1"></a>
          </div>
      ...
      <div class="repitem half-box">
        ...
        <div id="graphCO8" class="parent_div"  style="position:relative;">
          ...
          <div class="icon_bg _mrgn_top20 top_rnded_crnrs3 hoverMenu" style="top:0px;right:0px;">
            <a href="javascript:void(0)" class="icon_one" title="Table"></a>
            <a href="javascript:void(0)" class="icon_two" title="FullScreen"></a>
            <a href="javascript:void(0)" class="icon_three" title="Print"></a>
            <a href="javascript:void(0)" class="icon_four1"></a>
          </div>
  ...
  <div class="dashboard-section-content dashboard-country-chart-section trends chart clearfix" style="display: none;">
    <div class="columnleft">
      ...
      <div id="graphCO1" class="parent_div" style="position:relative;">
        ...
        <div class="icon_bg _mrgn_top20 top_rnded_crnrs3 hoverMenu" style="top:-10px;right:0px;">
          <a href="javascript:void(0)" class="icon_one" title="Table"></a>
          <a href="javascript:void(0)" class="icon_two" title="FullScreen"></a>
          <a href="javascript:void(0)" class="icon_three" title="Print"></a>
          <a href="javascript:void(0)" class="icon_four1"></a>
      ...
      <div class="country-chart-left-section first-column chart-sections">
        ...
        <div class="columnright">
          ...
          <div id="graphCO2" class="parent_div" style="position:relative;">
            ...
            <div class="icon_bg _mrgn_top20 top_rnded_crnrs3 hoverMenu" style="top:-10px;right:2px;">
              <a href="javascript:void(0)" class="icon_one" title="Table"></a>
              <a href="javascript:void(0)" class="icon_two" title="FullScreen"></a>
              <a href="javascript:void(0)" class="icon_three" title="Print"></a>
              <a href="javascript:void(0)" class="icon_four1"></a>
