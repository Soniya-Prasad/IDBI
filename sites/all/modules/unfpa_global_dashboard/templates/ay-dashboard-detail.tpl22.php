      ...
      <div id="map_render_child_mrg" class="chart-map-block map-div">
        ...
        <!--        <div class="clear dwnld_div box">
                  <div id="icon_bg" class="icns_img1">
                    ...
                    <a href="javascript:void('0');" class="fullscreen" title="Fullscreen" alt="Fullscreen">Fullscreen</a>
                  </div>
                </div>-->
    ...
    <div class="country-chart-section-left chart-sections">
      ...
      <div id="filter-options-list">
        <ul class="square-input-element graphfilter graphfilter_sr_ever_had_all_girl_15_19" style="display:none;">
          <li class="filter-option"><span><input class="first" type="radio" name="ay-graph-indicator-filter" id="sr_perc_female_sexuly_active" value="all_girl_15_19" checked="true" ><label> Total 15-19 year old girls</label></span></li>
...
<div id="family-planning-section" class="dashboard-country-outer-box adolescents-youth-dashboard">
  ...
  <div class="section-indicators" id="family-planning-indicators">
    <ul id="tab1">
      ...
      <li class="second"><span><input type="radio" name="family-planning-indicators" id="" class="fm_age_15_19_using_contrcptn_mthd" value="perc_mrd_girl_age_20_24_using_mdrn_contrcptn_mthd"/><label>Percentage of currently married/in union females aged 15-24 who are currently using any modern contraceptive method</label></span></li>

      <li class="third"><span><input type="radio" name="family-planning-indicators" id="" class="fm_age_15_19_using_contrcptn_mthd" value="perc_mrd_girl_age_15_19_not_using_contrcptn_mthd"/><label>Percentage of currently married/in union females aged 15-24 who are not currently using any contraceptive method</label></span></li>
  ...
  <div class="dashboard-section-content dashboard-country-chart-section clearfix">
    ...
    <div class="country-chart-section-left chart-sections">
      ...
      <div id="filter-options-list">
        <ul class="square-input-element graphfilter graphfilter_fm_age_15_19_using_contrcptn_mthd" style="display:none;">
    ...
    <div class="country-chart-section-right chart-sections">
      ...
      <div id="p-VO_10">
        ...
        <!-- graph div -->
        <div class="graph clear flt_lft wid99 bar_chart graph_fm_age_15_19_using_contrcptn_mthd table_fm_age_15_19_using_contrcptn_mthd" id='graph_perc_mrd_female_used_or_not_contrcptn' style="display:none"></div>
      </div>
      <div id="p-VO_11">
...
<div id="gender-equality-section" class="dashboard-country-outer-box adolescents-youth-dashboard">
  ...
  <div class="section-indicators" id="gender-equality-indicators">
    <ul id="tab1">
      ...
      <li class="first"><span><input type="radio" name="gender-equality-indicators" id="" checked="true"/><label class="label1">Proportion of women 15-24 involved in decision making for contraceptive use</label></span></li>

      <li class="second"><span><input type="radio" name="gender-equality-indicators" id=""/><label>Proportion of women 15-24 involved in decision making for own health care</label></span></li>

      <li class="third"><span><input type="radio" name="gender-equality-indicators" id="" class="" value=""/><label>Percentage of currently married/in union females aged 15-24 who have their contraception demand satisfied</label></span></li>
  ...
  <div class="dashboard-section-content dashboard-country-chart-section clearfix">
    ...
    <div class="country-chart-section-left chart-sections">
      ...
      <div id="chart-buttons-wrapper" class="clearfix">
        ...
        <button type="button" class="button graph" name="graphfiltr" id="graph_ge_age_15_24_take_contrcptn_des">Graph</button>
        <button type="button" class="button table graph_table" id="table_ge_age_15_24_take_contrcptn_des">Table</button>
      </div>
    ...
    <div class="country-chart-section-right chart-sections">
      <div id="map_render_gender_equality" class="chart-map-block map-div">
        ...
        <!-- graph div -->
        <div class="map_part" id='map_area_indicator_gender_equality' style="height:450px;margin-top:-15px"></div>
      </div>
      <div id="p-VO_16">

        <!-- graph div -->
        <div class="graph chart_plc bar_chart graph_ge_age_15_24_take_contrcptn_desc table_ge_age_15_24_take_contrcptn_desc" id='graph_perc_female_take_contrcptn_desc_byself_or_with_hsbnd' style="display: none;"></div>
      </div>
      <div id="p-VO_12">
  ...
  <div class="dashboard-country-detail-section-content clearfix">
    <ul class="clearfix">
      ...
      <li class="list-row adolescent-youth-dashboard-list-row">
        <a href="/data/dashboard/adolescent-youth/NP">
      ...
      <li class="list-row world-population-dashboard-list-row">
        <a href="/world-population-dashboard#NP">
