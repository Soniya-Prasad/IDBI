...
<h1 id="page-title" class="title custom-page-title">Female Genital Mutilation Dashboard (FGM) - <?php echo $country_name; ?></h1>
<span class="fullscreen-table-title"></span>
...
<div id="fgm-overview-section" class="dashboard-country-outer-box fgm-dashboard">
  ...
  <div class="dashboard-section-content dashboard-country-chart-section levels chart clearfix">
    ...
    <div class="overview-map-section overview-section">
      <h2 id="div1" class="dashboard-country-chart-section-title"></h2>
<!--      <h2 id="div1" class="dashboard-country-chart-section-title"><span class="title-bold-text fgm-dashboard-color">27%</span> of women aged 15-49 in <?php // print $country_name;                ?> have undergone some form of FGM</h2>-->
      <!--      <div class="repitem">
              <span class="leftarrow" id="dntRemv">Levels: </span>
              <p style="min-height:35px;"><span id="div1">currently, 26% of women aged 15-49 in Senegal have undergone some form of FGM</span></p>
            </div>-->
          ...
          <div class="conteudo">
            <div class="clearfix">
              ...
              <div id ="map_render" class="columnleft">
                <h2 class="print-subtitle" style="display: none;">27% of women aged 15-49 in <?php echo $country_name; ?> have undergone some form of FGM</h2>
                <div class="map_div" id="mapDivId" style="height: 324px;">
                </div>
              ...
              <div id="action-links" class="action-links-block _mrgn_top20 top_rnded_crnrs3 hoverMenu">
                <ul rel="MO1" class="action-link-list" id="">
                  <li rel="fullScreen" class="full-view"><a href="javascript:void(0)" class="icon_two" title="FullScreen">FullScreen</a></li>
                  <li rel="table" class="table"><a href="javascript:void(0);" title="Table" class="map_graph_table"><i>Table</i></a></li>
                  <li rel="print" class="print"><a href="javascript:void(0);" class="dfapi-viz-toolbar-medium print icon_three"><i>Print</i></a></li>
                  <li rel="MO1" class="download dwnld-option-li">
                    ...
                    <div rel="download" class="download-link-options dwnld-opts">
                      ...
                      <a id="csv" type="csv" href="javascript:void(0);" class="export export_icons">CSV </a>
                    </div>
                  </li>
                </ul>
              </div>
      ...
      <div class="country-chart-left-section first-column chart-sections">
        <div class="conteudo">
          <div class="repitem half-box">
            <p style="min-height:80px;"><span id="div9" class="txt_hgt  get-print-title" style="width:90%; min-height:110px;font-size: 12px;"></span></p>
            <div id="graphCO8" class="parent_div"  style="position:relative;">
              <h2  id="div9" class="print-subtitle" style="display: none;">More than 65% of the women who have undergone FGM were cut before age 5; the difference of age at FGM between women 15-19 and women 45-49 indicates that more girls are likely to be cut at an earlier age</h2>
              <!--<div class="BoxClose" style="float:right;cursor:pointer;display:none;margin:10px;">
                     <a href="#" class="icon_tbl_fs" title="Table"></a>
                     <a href="#" class="icon_three" title="Print"></a>
                     <a href="javascript:void(0)" class="icon_four" id="Fullscreen"></a>
            ...
            <div id="action-links" class="action-links-block _mrgn_top20 top_rnded_crnrs3 hoverMenu">
              <ul class="action-link-list" id="">
                <li rel="fullScreen" class="full-view"><a href="javascript:void(0)" class="icon_two" title="FullScreen">FullScreen</a></li>
                <li rel="table" class="table"><a href="javascript:void(0);" title="Table" class="dfapi-viz-toolbar-medium icon_one"><i>Table</i></a></li>
                <li rel="print" class="print"><a href="javascript:void(0);" class="dfapi-viz-toolbar-medium print icon_three" title="Print">Print</a></li>
      ...
      <div class="country-chart-right-section last-column chart-sections">
        <div class="overview-chart-section overview-section conteudo">
          <div class="repitem">
            ...
            <p><span id="div7" class="txt_hgt get-print-title" style="width:95%; min-height:auto; font-size: 12px;"></span><br/>
            ...
            <div id="graphCO7" class="parent_div"  style="position:relative;">
              <h2  class="print-subtitle" style="display: none;">19% of daughters aged 0-14 in Nigeria have undergone some form of FGM
                Indicator captures a certain point in time and not an eternal truth, as these young girls might be cut at a later stage in their lives</h2>
              <!--<div class="BoxClose" style="float:right;cursor:pointer;display:none;margin:10px;">
                      <a href="#" class="icon_tbl_fs" title="Table"></a>
                      <a href="#" class="icon_three" title="Print"></a>
                      <a href="javascript:void(0)" class="icon_four" id="Fullscreen"></a>
  ...
  <div class="dashboard-section-content dashboard-country-chart-section projections chart clearfix">
    <div class="two-column-wrapper clearfix">
            ...
            <div class="clearfix">
              <div class="columnleft">
                <div class="repitem"> <span class=""></span>
                  <p><div id="div4"  class="dashboard-country-chart-section-sub-title txt_hgt get-print-title" style=" width:90%; min-height:65px">To meet the target of reducing FGM rate by half, more resources are needed</div></p>
                </div>

                <div id="graphCO3" class="parent_div"  style="position:relative;">
                  <h2 class="print-subtitle" style="display: none;">To meet the target of reducing FGM rate by half, more resources are needed</h2>
                ...
                <div id="action-links" class="action-links-block _mrgn_top20 top_rnded_crnrs3 hoverMenu">
                  <ul rel="MO1" class="action-link-list" id="">
                    ...
                    <li rel="print" class="print"><a href="javascript:void(0);" class="dfapi-viz-toolbar-medium print icon_three"><i>Print</i></a></li>
                    <li rel="MO1" class="download dwnld-option-li">
                      <a class="download-link" href="javascript:void(0);"><i class="dfapi-viz-toolbar-medium">Download</i></a>
      ...
      <div class="country-chart-right-section last-column chart-sections">
        <div class="columnright">
          <div class="repitem">
            <p></span><div id="div5" class="dashboard-country-chart-section-sub-title txt_hgt get-print-title" style=" width:90%; min-height:65px;">If present trends continue, 285,000 girls born between 2010-2015 will experience FGM by 2030 </div></p>
          </div>


          <div id="graphCO4" class="parent_div"  style="position:relative;">
            <h2 class="print-subtitle" style="display: none;">If present trends continue, 2,718,000 girls born between 2010-2015 will experience FGM by 2030</h2>
            <!--<div class="BoxClose" style="float:right;cursor:pointer;display:none;margin:10px;">
           <a href="#" class="icon_tbl_fs" title="Table"></a>
           <a href="#" class="icon_three" title="Print"></a>
           <a href="javascript:void(0)" class="icon_four" id="Fullscreen"></a>
  ...
  <div class="dashboard-section-content dashboard-country-chart-section trends chart clearfix" style="display: none;">
    <div class="columnleft">
      <div class="repitem">
        ...
        <p><div id="div2" class="dashboard-country-chart-section-sub-title get-print-title">Prevalence of FGM has increased by 5% between 2006 and 2010; FGM is less common among girls 15-19 than women 45-49</div></p>

      </div>

      <div id="graphCO1" class="parent_div" style="position:relative;">
        <h2 class="print-subtitle" style="display: none;"> Prevalence of FGM has decreased by 9% between 2008 and 2011; FGM is less common among girls 15-19 than women 45-49</h2>
        <!--<div class="BoxClose" style="float:right;cursor:pointer;display:none;margin:10px;">
                <a href="#" class="icon_tbl_fs" title="Table"></a>
                <a href="#" class="icon_three" title="Print"></a>
                <a href="javascript:void(0)" class="icon_four" id="Fullscreen"></a>
  ...
  <div class="dashboard-section-content dashboard-country-chart-section clearfix">
    ...
    <div class="two-column-wrapper clearfix">
        ...
        <div class="country-inside-top-filter-section">
          <div id="filter-options-list" class="neighbour-blocks">
            ...
            <ul class="square-input-element" id="filter_inequalities_opposition">
              ...
              <li class="filter-option"><span><input class="first" type="radio" name="fgm-inequality-op-indicator-filter" id="" value="all_inequalities_opposition"><label> All</label></span></li>
            </ul>
          </div>
        </div>
        <h2 class="dashboard-country-chart-section-title">Inequalities</h2>
        <div id="div3" class="dashboard-country-chart-section-sub-title get-print-title">Human rights violations affect females differently. Girls who are the least educated are at the greatest risk of FGM</div>
        <div class="columnright">


          <div id="graphCO2" class="parent_div" style="position:relative;">
            <h2 class="print-subtitle" style="display: none;">Human rights violations affect females differently. Girls who are the least educated are at the greatest risk of FGM</h2>
            ...
            <div class="bdrcls residence inequalities_opposition_graph residence_inequalities_graph active" id="CO2"></div>
            <div class="bdrcls wealth inequalities_opposition_graph wealth_inequalities_graph" id="CO20" style="display:none;"></div>
            <div class="bdrcls education inequalities_opposition_graph education_inequalities_graph" id="CO21" style="display:none;"></div>
            <div class="bdrcls all_inequalities_opposition inequalities_opposition_graph all_inequalities_opposition_inequalities_graph" id="CO25" style="display:none;"></div>
            <!--            <div class="_mrgn_top20 top_rnded_crnrs3 hoverMenu" style="top:-10px;right:2px;">
                          <a href="javascript:void(0)" class="icon_one" title="Table">Table</a>
                          <a href="javascript:void(0)" class="icon_two" title="FullScreen">FullScreen</a>
                          <a href="javascript:void(0)" class="icon_three" title="Print">Print</a>
      ...
      <div class="country-chart-right-section last-column chart-sections">
        ...
        <div id="div6" class="dashboard-country-chart-section-sub-title get-print-title">About <span class="title-bold-text fgm-dashboard-color">66 percent</span> of women believe FGM should be discontinued</div>
...
<!--          <p style="min-height:80px;">
          ...
          <div id="graphCO5" class="parent_div"  style="position:relative;">
            <h2 class="print-subtitle" style="display: none;">About <span class="title-bold-text fgm-dashboard-color">66 percent</span> of women believe FGM should be discontinued</h2>
            <div class="residence inequalities_opposition_graph">Residence</div>
            <div class="education inequalities_opposition_graph" style="display: none;">Education Level</div>
            <div class="wealth inequalities_opposition_graph" style="display: none;">Wealth Quintile</div>
            <div class="repitem"></div>
            ...
            <div class="bdrcls residence inequalities_opposition_graph residence_opposition_graph active" id="CO22"></div>
            <div class="bdrcls education inequalities_opposition_graph education_opposition_graph" id="CO23" style="display:none;"></div>
            <div class="bdrcls wealth inequalities_opposition_graph wealth_opposition_graph" id="CO24" style="display:none;"></div>
            <div class="bdrcls all_inequalities_opposition inequalities_opposition_graph all_inequalities_opposition_opposition_graph" id="CO5" style="display:none;"></div>
...
<div id="fgm-performers-section" class="dashboard-country-outer-box fgm-dashboard">
  ...
  <div class="dashboard-section-content dashboard-country-chart-section performers-of-fgm chart clearfix">
    ...
    <div class="two-column-wrapper uneven-width clearfix">
      ...
      <div class="country-chart-right-section last-column chart-sections">
        <div class="repitem half-box right-box">
          <div id="div11" class="dashboard-country-chart-section-sub-title get-print-title">FGM is essentially performed by other traditional (more than <span class="title-bold-text fgm-dashboard-color">65%</span>). FGM is practised more and more by medical professionals</div>
          <div id="graphCO10" class="parent_div"  style="position:relative;">
            <h2 class="print-subtitle" style="display: none;">FGM is essentially performed by other traditional (more than <span class="title-bold-text fgm-dashboard-color">65%</span>). FGM is practised more and more by medical professionals</h2>
            <!--<div class="BoxClose" style="float:right;cursor:pointer;display:none;margin:10px;">
                    <a href="#" class="icon_tbl_fs" title="Table"></a>
                    <a href="#" class="icon_three" title="Print"></a>
                    <a href="javascript:void(0)" class="icon_four" id="Fullscreen"></a>
  ...
  <div class="dashboard-section-content dashboard-country-chart-section type-of-fgm chart clearfix" style="display:none;">
    ...
    <div class="two-column-wrapper uneven-width clearfix">
      ...
      <div class="country-chart-right-section last-column chart-sections">
        <div id="div10" class="dashboard-country-chart-section-sub-title get-print-title">Almost half of girls and women who undergone FGM have had their genitalia cut, with some flesh removed</div>
        <div class="repitem half-box right-box">
          <div id="graphCO9" class="parent_div"  style="position:relative;width:100%">
            <h2 class="print-subtitle" style="display: none;">Almost half of girls and women who undergone FGM have had their genitalia cut, with some flesh removed</h2>
            <!--<div class="BoxClose" style="float:right;cursor:pointer;display:none;margin:10px;">
                   <a href="#" class="icon_tbl_fs" title="Table"></a>
                   <a href="#" class="icon_three" title="Print"></a>
                   <a href="javascript:void(0)" class="icon_four" id="Fullscreen"></a>
          ...
          <div id="action-links" class="action-links-block _mrgn_top20 top_rnded_crnrs3 hoverMenu">
            <ul rel="MO1" class="action-link-list" id="">
              <li rel="fullScreen" class="full-view"><a href="javascript:void(0)" class="icon_two" title="FullScreen">FullScreen</a></li>
              <li rel="table" class="table"><a href="javascript:void(0);" title="Table" class="dfapi-viz-toolbar-medium icon_one"><i>Table</i></a></li>
              <li rel="print" class="print"><a href="javascript:void(0);" title="Print" class="dfapi-viz-toolbar-medium print icon_three"><i>Print</i></a></li>
              <li rel="MO1" class="download dwnld-option-li">
                <a class="download-link" href="javascript:void(0);" title="Download"><i class="dfapi-viz-toolbar-medium dwnld">Download</i></a>
                <div rel="download" class="download-link-options">
                  <a id="png" type="png" href="javascript:void(0);" class="export export_icons">PNG </a>
