...
<div id="child-marriage-section" class="dashboard-country-outer-box">
  ...
  <div class="dashboard-section-content dashboard-country-chart-section clearfix">
    ...
    <div class="country-chart-section-left chart-sections">
      ...
      <div class="mrgn_btm10 sltindc" style='min-height:90px;display:none'>
        ...
        <div id="chart-buttons-wrapper" class="child-marriage-indicators">
        ...
        <button type="button" class="button table map_table">Table</button>
      </div>
      ...
      <div id="map_render">
        ...
        <div class="CO3">
          ...
          <div id="p-VO_8">
            ...
            <!-- graph div -->
            <div class="graph flt_lft wid99 graph_cm_age_by_18_15 bar_chart" id="graph_adolescnt_mrg" style="display:none"></div>
          </div>
        </div>
  ...
  <div id="p-VO_15">
            ...
            <!-- graph div -->
            <div class="graph chart_plc graph_cm_perc_wife_think_beating_jusfd_girl_15_24 bar_chart" id='graph_perc_wife_think_beating_jusfd' style="display: none"></div>
          </div>
...
<div id="p-VO_14">
  ...
  <!-- graph div -->
  <div class="graph clear chart_plc graph_cm_perc_15_24_age_diff_btwn_female_and_partnr_girl_10_or_more bar_chart" id='graph_perc_age_diff_btwn_female_and_partnr' style="display:none"></div>
</div>
    </div>
